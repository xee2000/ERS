...
<body class="body">
	<nav class="navbar navbar-expand-md navbar-light navbar-white" style="padding: 0px;">
  <div class="header_main">
    ...
    <div class="head_title collapse navbar-collapse order-3" id="navbarCollapse">
      <div class="brand_text" onclick="location.href='/ers/lsupporter/main'">DALORAND</div>
    </div>
    ...
    <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
      ...
      <!-- 공지사항 -->
      <li class="item_bar">
        <img style="width: 70px; height: 70px;"src="/resources/lsupporter/img/확성기.png" alt="">
